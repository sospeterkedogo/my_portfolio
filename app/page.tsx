...
<section id="skills" className="relative w-full h-screen bg-gray-900">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 h-full">
    ...
    <BlogGrid />
      ...
      {/* About Me */}
      <section id="about" className="w-full max-w-7xl mx-auto px-6 bg-white py-12 ">
        
        <div>
          <h2 className="font-[var(--font-inter)] text-1xl font-bold text-gray uppercase tracking-wide opacity-30">SOSPETER KEDOGO</h2>
          <h2 className="font-[var(--font-inter)] text-3xl font-bold mb-3 text-gray opacity-60">ABOUT ME</h2>
          <p className="text-lg text-gray opacity-70">
