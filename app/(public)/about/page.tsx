...
export const metadata: Metadata = {
  ...
  description: "Full-stack developer based in Northampton, UK.",
};
      ...
      <header className="px-6 md:px-24 pt-32 pb-20 border-b border-neutral-300">
        <div className="max-w-5xl">
            ...
            <p className="text-xl md:text-2xl text-neutral-600 max-w-2xl leading-relaxed font-medium">
                I'm a Full-Stack Developer based in Northampton, UK. I like building things that work, looking at code that makes sense, and solving problems that actually matter.
            </p>
        </div>
      </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-24">
           ...
           <div className="md:col-span-7 flex flex-col gap-20">
              ...
              <div className="prose prose-lg prose-neutral max-w-none text-neutral-800">
                 ...
                 <p>
                    I didn't start coding because I wanted to be a "ninja" or a "rockstar." I started because I liked the idea of typing something into a computer and seeing it come to life on the screen.
                 </p>
                 <p>
              ...
              <div className="prose prose-lg prose-neutral max-w-none text-neutral-800">
                 ...
                 <p>
                    When I'm not debugging, I'm usually hanging out with friends, playing video games, or exploring the beautiful scenery of the United Kingdom. I believe stepping away from the screen is the best way to solve a difficult problem.
                 </p>
              </div>
